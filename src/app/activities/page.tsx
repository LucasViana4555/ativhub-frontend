...
import { Sword, CheckCircle2, Send, ArrowLeft } from "lucide-react";
  ...
  return (
    <main className="min-h-screen relative overflow-hidden pt-24 pb-12 px-4">
      ...
      <div className="absolute top-0 left-0 w-full p-6 flex justify-between items-center z-50">
        <div className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-neon-green to-purple-500 glow-text cursor-pointer" onClick={() => router.push("/dashboard")}>
          AtivHub
        </div>
